...
void agregarNodo(Nodo*& cabeza, int valor) {
	Nodo* nuevoNodo = new Nodo; //Creando el aúntador hacia el nuevo nodo
...
int main() {
	...
	int tamanoLista;
	cout << "Ingrese la cantidad de elementos wue desea agregar a la lista:";
	cin >> tamanoLista;
